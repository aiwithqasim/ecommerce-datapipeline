...
CREATE or replace STORAGE INTEGRATION S3_INTEGRATION_PRO
  TYPE = EXTERNAL_STAGE
  STORAGE_PROVIDER = S3
  STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::191015975005:role/ecommerece-datapipelince-snowflake-role-qh'
  ENABLED = TRUE
  STORAGE_ALLOWED_LOCATIONS = ('s3://ecommerece-datapipeline-qh/firehose/');
